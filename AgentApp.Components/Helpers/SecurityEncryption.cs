...
namespace AgentApp.Components.Helpers
{
    public static class SecurityEncryption
    {
        ...
        {
            string EncryptionKey = "0123456789ABCWBDCAFDTRGBDSCXSTUVWXYZ";
            cipherText = (cipherText ?? string.Empty).Replace(" ", "+");
        ...
        public static int GetOrignialNumber(string num)
        {
            return string.IsNullOrEmpty(num) ? 0 : Convert.ToInt32(SecurityEncryption.DecryptNumber(num));
        }
